...
export const PRODUCTS: Product[] = [
  // ===== 행사용 현수막 =====
  {
    ...
    basePrice: 30000,
    imageUrl: 'https://picsum.photos/seed/banner-forest/400/400',
    isDigital: false,
  ...
  },
  {
    ...
    basePrice: 32000,
    imageUrl: 'https://picsum.photos/seed/banner-sports/400/400',
    isDigital: false,
    requiresCustomText: true,
    badge: '베스트',
  ...
  },
  {
    ...
    basePrice: 30000,
    imageUrl: 'https://picsum.photos/seed/banner-entrance/400/400',
    isDigital: false,
    requiresCustomText: true,
  ...
  // ===== 포맥스 환경구성판 =====
  {
    ...
    basePrice: 41000,
    imageUrl: 'https://picsum.photos/seed/foamex-medicine/400/400',
    isDigital: false,
    requiresCustomText: true,
  ...
  },
  {
    ...
    basePrice: 35000,
    imageUrl: 'https://picsum.photos/seed/foamex-observe/400/400',
    isDigital: false,
    requiresCustomText: true,
  ...
  },
  {
    ...
    name: '미세먼지 안내판·현황판',
    basePrice: 39000,
    imageUrl: 'https://picsum.photos/seed/foamex-dust/400/400',
    isDigital: false,
    requiresCustomText: true,
  ...
  // ===== 패트 배너 =====
  {
    ...
    basePrice: 28000,
    imageUrl: 'https://picsum.photos/seed/pet-sports/400/400',
    isDigital: false,
    requiresCustomText: true,
  ...
  },
  {
    ...
    basePrice: 12000,
    imageUrl: 'https://picsum.photos/seed/pet-graduation/400/400',
    isDigital: false,
    requiresCustomText: true,
  ...
  // ===== 굿즈 & 스티커 =====
  {
    ...
    basePrice: 28000,
    imageUrl: 'https://picsum.photos/seed/sticker-car/400/400',
    isDigital: false,
    requiresCustomText: true,
    badge: '인기',
  ...
  },
  {
    ...
    name: '탄소중립 환경보호 어깨띠',
    basePrice: 3500,
    imageUrl: 'https://picsum.photos/seed/sash-green/400/400',
    isDigital: false,
  ...
  },
  {
    ...
    basePrice: 5500,
    imageUrl: 'https://picsum.photos/seed/sticker-name/400/400',
    isDigital: false,
    requiresCustomText: true,
  ...
  // ===== 디지털 도안 =====
  {
    ...
    name: '나를 소개해요 도안세트',
    basePrice: 3500,
    imageUrl: 'https://picsum.photos/seed/digital-introduce/400/400',
    isDigital: true,
    requiresCustomText: false,
    badge: '디지털',
  ...
  },
  {
    ...
    name: '병아리 학급현황판 도안',
    basePrice: 1800,
    imageUrl: 'https://picsum.photos/seed/digital-chick/400/400',
    isDigital: true,
    requiresCustomText: false,
    badge: '디지털',
  ...
  },
  {
    ...
    name: '화분이름표 도안',
    basePrice: 1800,
    imageUrl: 'https://picsum.photos/seed/digital-flowerpot/400/400',
    isDigital: true,
    requiresCustomText: false,
    badge: '디지털',
  ...
  },
  {
    ...
    basePrice: 3500,
    imageUrl: 'https://picsum.photos/seed/digital-concert/400/400',
    isDigital: true,
    requiresCustomText: false,
    badge: '디지털',
